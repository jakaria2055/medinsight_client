      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-2xl overflow-hidden">
        ...
        <div className="p-6 md:flex md:gap-8">
          ...
          <div className="flex-1 mt-6 md:mt-0">
            ...
            {/* Company Info */}
            {company && (
              <div className="flex items-center gap-4 bg-blue-50 p-4 rounded-lg shadow-sm mb-5">
                <img
                  src={company.image}
                  alt={company.name}
            ...
            <div className="mb-5">
              <h3 className="text-lg bg-blue-100 px-2 font-semibold text-blue-600 mb-1">
                Effectiveness
              </h3>
            ...
            <div>
              <h3 className="text-lg bg-red-100 px-2 font-semibold text-[#B91C1C] mb-1">
